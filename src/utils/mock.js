...
// const filtered_products = mProducts.filter(product => product.featured)

const mFilterContext = {
  filtered_products: mProducts.filter(product => product.featured),
  grid_view: true,
  updateSort: jest.fn(),
  options: {
    categories: [
